...
Если проект уже существует сначала генератор его загрузит и будет использовать как основу для будуших xml. Так же при вводе неймспейсов для таблиц предлагается выбрать из существующих в проекте.
...
Все неймспейсы таже запишутся в mfd файл, который сохранится по указанному в команде пути.
