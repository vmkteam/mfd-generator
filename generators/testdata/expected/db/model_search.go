// Code generated by mfd-generator (devel); DO NOT EDIT.
...
func (cs *CategorySearch) applyFields(query *orm.Query) *orm.Query {
	if cs == nil {
		return query
	}
	if cs.ID != nil {
...
func (cs *CategorySearch) applyWithError(query *orm.Query) (*orm.Query, error) {
	if cs == nil {
		return query, nil
	}
	return cs.search.applyWithError(cs.applyFields(query))
}

func (cs *CategorySearch) Q() applier {
	return func(query *orm.Query) (*orm.Query, error) {
		return cs.applyWithError(query)
	}
}
...
func (ns *NewsSearch) applyFields(query *orm.Query) *orm.Query {
	if ns == nil {
		return query
	}
	if ns.ID != nil {
...
func (ns *NewsSearch) applyWithError(query *orm.Query) (*orm.Query, error) {
	if ns == nil {
		return query, nil
	}
	return ns.search.applyWithError(ns.applyFields(query))
}

func (ns *NewsSearch) Q() applier {
	return func(query *orm.Query) (*orm.Query, error) {
		return ns.applyWithError(query)
	}
}
...
func (ts *TagSearch) applyFields(query *orm.Query) *orm.Query {
	if ts == nil {
		return query
	}
	if ts.ID != nil {
...
func (ts *TagSearch) applyWithError(query *orm.Query) (*orm.Query, error) {
	if ts == nil {
		return query, nil
	}
	return ts.search.applyWithError(ts.applyFields(query))
}

func (ts *TagSearch) Q() applier {
	return func(query *orm.Query) (*orm.Query, error) {
		return ts.applyWithError(query)
	}
}
...
func (cs *CitySearch) applyFields(query *orm.Query) *orm.Query {
	if cs == nil {
		return query
	}
	if cs.ID != nil {
...
func (cs *CitySearch) applyWithError(query *orm.Query) (*orm.Query, error) {
	if cs == nil {
		return query, nil
	}
	return cs.search.applyWithError(cs.applyFields(query))
...
func (cs *CountrySearch) applyFields(query *orm.Query) *orm.Query {
	if cs == nil {
		return query
	}
	if cs.ID != nil {
...
func (cs *CountrySearch) applyWithError(query *orm.Query) (*orm.Query, error) {
	if cs == nil {
		return query, nil
	}
	return cs.search.applyWithError(cs.applyFields(query))
...
func (rs *RegionSearch) applyFields(query *orm.Query) *orm.Query {
	if rs == nil {
		return query
	}
	if rs.ID != nil {
...
func (rs *RegionSearch) applyWithError(query *orm.Query) (*orm.Query, error) {
	if rs == nil {
		return query, nil
	}
	return rs.search.applyWithError(rs.applyFields(query))
}

func (rs *RegionSearch) Q() applier {
	return func(query *orm.Query) (*orm.Query, error) {
		return rs.applyWithError(query)
	}
}
...
func (eks *EncryptionKeySearch) applyFields(query *orm.Query) *orm.Query {
	if eks == nil {
		return query
	}
	if eks.ID != nil {
...
func (eks *EncryptionKeySearch) applyWithError(query *orm.Query) (*orm.Query, error) {
	if eks == nil {
		return query, nil
	}
	return eks.search.applyWithError(eks.applyFields(query))
}

func (eks *EncryptionKeySearch) Q() applier {
	return func(query *orm.Query) (*orm.Query, error) {
		return eks.applyWithError(query)
	}
}
...
func (lcs *LoginCodeSearch) applyFields(query *orm.Query) *orm.Query {
	if lcs == nil {
		return query
	}
	if lcs.ID != nil {
...
func (lcs *LoginCodeSearch) applyWithError(query *orm.Query) (*orm.Query, error) {
	if lcs == nil {
		return query, nil
	}
	return lcs.search.applyWithError(lcs.applyFields(query))
}

func (lcs *LoginCodeSearch) Q() applier {
	return func(query *orm.Query) (*orm.Query, error) {
		return lcs.applyWithError(query)
	}
}
...
func (sus *SiteUserSearch) applyFields(query *orm.Query) *orm.Query {
	if sus == nil {
		return query
	}
	if sus.ID != nil {
...
func (sus *SiteUserSearch) applyWithError(query *orm.Query) (*orm.Query, error) {
	if sus == nil {
		return query, nil
	}
	return sus.search.applyWithError(sus.applyFields(query))
}

func (sus *SiteUserSearch) Q() applier {
	return func(query *orm.Query) (*orm.Query, error) {
		return sus.applyWithError(query)
	}
}
...
func (vfs *VfsFileSearch) applyFields(query *orm.Query) *orm.Query {
	if vfs == nil {
		return query
	}
	if vfs.ID != nil {
...
func (vfs *VfsFileSearch) applyWithError(query *orm.Query) (*orm.Query, error) {
	if vfs == nil {
		return query, nil
	}
	return vfs.search.applyWithError(vfs.applyFields(query))
}

func (vfs *VfsFileSearch) Q() applier {
	return func(query *orm.Query) (*orm.Query, error) {
		return vfs.applyWithError(query)
	}
}
...
func (vfs *VfsFolderSearch) applyFields(query *orm.Query) *orm.Query {
	if vfs == nil {
		return query
	}
	if vfs.ID != nil {
...
func (vfs *VfsFolderSearch) applyWithError(query *orm.Query) (*orm.Query, error) {
	if vfs == nil {
		return query, nil
	}
	return vfs.search.applyWithError(vfs.applyFields(query))
