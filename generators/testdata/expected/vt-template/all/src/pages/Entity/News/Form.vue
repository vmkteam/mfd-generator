              ...
              <v-tabs-items v-model="tab">
                <v-tab-item eager>
                  ...
                  <vt-form-field
                    ...
                    required
                  /><vt-form-field
                    v-model="store.model.preview"
                    component="v-text-field"
                    :label="$t('news.form.previewLabel')"
                    :error-messages="$t(i18nFieldError(store.errors.preview))"
                    :disabled="store.isLoading"
                    placeholder=""
                    clearable
                  /><vt-form-field
                  ...
                  /><vt-form-field
                    ...
                    chips
                  /><vt-form-field
                    v-model="store.model.publishedAt"
                    component="vt-datetime-picker"
                    :label="$t('news.form.publishedAtLabel')"
                    :error-messages="$t(i18nFieldError(store.errors.publishedAt))"
                    :disabled="store.isLoading"
                    placeholder=""
                    clearable
                    iso
