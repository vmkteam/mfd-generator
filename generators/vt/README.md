...
Сгенерированный код предназначен для использования в качестве сервиса zen-rpc. В консоль выводится код, который можно использовать в настройке zen-rpc  
Зависит от пакета "embedlog" (например, "blog-api/pkg/embedlog") и пакета "github.com/semrush/zenrpc", который используется как сервис  
